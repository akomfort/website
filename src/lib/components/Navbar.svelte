<header>
    <div class="bg-blue-600 py-2">
        <div class="flex justify-start max-w-[85rem] mx-auto px-4 lg:px-8 text-white text-sm font-bold">
            <div class=" divide-white divide-x-2">
                <span class="pr-4">Po-Pia 10:00 - 20:00</span>
                <a class="px-4" href="tel:+421912123123">+421 912 123 123</a>
                <a class="pl-4" href="mailto:email@email.com">email@email.com</a>
            </div>
        </div>
    </div>
    <div class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm py-3 md:py-0 dark:bg-gray-800">
        <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
            ...
            <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                ...
                <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:pl-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                    <a class="font-bold text-blue-600 py-3 md:py-6 dark:text-blue-500" href="#" aria-current="page">Landing</a>

                    <a class="font-bold text-black hover:text-gray-700 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="#">
                        Company
                    </a>

                    <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:py-4">
                    <button type="button" class="flex items-center w-full text-black hover:text-gray-700 font-bold dark:text-gray-400 dark:hover:text-gray-500">
                        Resources
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full left-0 min-w-[15rem] bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-gray-800 dark:divide-gray-700 before:absolute before:-top-5 before:left-0 before:w-full before:h-5">
                        ...
                        <div class="flex flex-col mx-1 md:mx-0">
                            <a class="group flex gap-x-5 text-gray-800 hover:bg-gray-50 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="#">
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">Support Docs</p>
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">Integrations</p>
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">API Reference</p>
                        ...
                        <div class="flex flex-col mx-1 md:mx-0">
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">Help Center</p>
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">Developer Hub</p>
                            ...
                            <div class="grow">
                                <p class="font-bold text-gray-800 dark:text-gray-200">Community Forum</p>
                        ...
                        <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                            ...
                            <img class="w-32 h-32 rounded-lg" src="" alt="Image Description">
                            <div class="grow">
                    ...
                    <a class="font-bold text-black hover:text-gray-700 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="#">
                    Join us <span class="py-0.5 px-1.5 rounded-full text-xs font-bold bg-blue-50 border border-blue-200 text-blue-600">4</span>
                    </a>
